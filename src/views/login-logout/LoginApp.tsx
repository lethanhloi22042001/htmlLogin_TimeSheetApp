...
// import { getAllUser } from "../sliceLogin";
import { fetchUser, postUser } from "./sliceLogin";
...
const LoginApp: React.FC<LoginProps> = ()=>{
    const {
      ...
      const allUser = useSelector( (state: RootState)=> state.Login_Form.entities);
      ...
      useEffect(() => {
        console.log('allUser Reducer', allUser);
      });
    return(
        <>
                    ...
                    <div className="loginTex">Log in</div>
                     <div className={`input-field `}>
                         ...
                         <div className="inputEnter" >
                            <input  
                                ...
                                type="text" name="usernameOrEmailAddress" id="usernameOrEmailAddress" 
                                required
                            />
                            <label htmlFor="usernameOrEmailAddress">User name or Email</label>
                            <span style={{ color: 'red', position: 'absolute', left: 0, top: '33px' }}>{errors.usernameOrEmailAddress  && errors.usernameOrEmailAddress.message }</span>
                         </div>
                     </div>
                     ...
                     <div className={`input-field`}>
                         ...
                         <div className="inputEnter">
                            ...
                            <span style={{ color: 'red', position: 'absolute', left: 0, top: '33px' }}>{errors.password  && errors.password.message }</span>
